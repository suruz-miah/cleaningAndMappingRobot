...
\begin{figure}
	...
	\caption{Bottom view of the proposed robot design}
...
%	\gantttitlelist{7,...,12}{1} \\
	...
	\ganttlinkedbar{Determine sensors to use}{2020-10}{2020-11} \ganttnewline
...
\begin{ganttchart}[
	...
	\ganttlinkedbar{Create system for connections with the onboard SBC}{2021-02}{2021-03} \ganttnewline
